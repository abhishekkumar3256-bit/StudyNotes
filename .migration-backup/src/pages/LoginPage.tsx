    ...
    <div className="flex min-h-screen items-center justify-center bg-stone-50 p-4">
      ...
      >
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-stone-900 text-white shadow-lg shadow-stone-200">
            <BookOpen size={28} />
          </div>
        ...
        <Card className="p-8 shadow-xl shadow-stone-200/50">
